export { ClientConfig } from '@orda/config';
export { Client } from '@orda/client';
export { SyncType } from '@orda/types/client';
...
export { OrdaMap, OrdaMapTx } from '@orda/datatypes/map';
export { OrdaDoc, OrdaDocTx } from '@orda/datatypes/document';

export { StateOfDatatype, TypeOfDatatype } from '@orda/types/datatype';
